            ...
            {loading ? ( 
                ...
                <>
                    ...
                    <div className="bg-blue-50 shadow-lg rounded-lg p-6 mb-6">
                        ...
                        <p className="mt-2"><strong>Category:</strong> {service.category}</p>
                        <p className="mt-2"><strong>Company Name:</strong> {service.companyName}</p>
                        <p className="mt-2">
                            <strong>Website:</strong> <a className="text-blue-700" href={service.website}>{service.website}</a>
                        </p>
                        <p className="mt-2"><strong>Price:</strong> BDT {service.price}</p>
                        <p className="mt-2"><strong>Added By:</strong> {service.userEmail}</p>
                        <p className="mt-2"><strong>Added On:</strong> {service.addedDate}</p>
                        <p className="mt-2"><strong>Total Reviews:</strong> {service.reviewCount ?? 0}</p>
                    </div>
